...
<head>
    ...
    <link rel="stylesheet" href="css/est-vale2Pro.css">
        ...
        <div class="titulo">
          ...
          <div class="t1">
           ...
           <h3 style="text-align: center;">Descripción:</h3>
            <br/><br/><br/>
           <h3 style="text-align: center;">Cantidad Solicitada:</h3>
            </div>   
            
            <form action="php/registrarv2.php" method="post">
             ...
             <div class="t2">                <input type="text" name="producto" id="producto" placeholder="Escribe algo..." style="height: 20px;" required> 
                ...
                <input type="text" name="cantidad" id="cantidad" placeholder="Escribe algo..." required >
                  ...
                  <form action="Pag/valePres.php" method="post" class="btn">
                      <input type="submit" value="Generar" id="boton1">
                  </form> 
                  <div class="nuevo">
                   <a href="vale2.html"><input type="submit" value="Realizar nueva solicitud" id="boton2"></a>
                 ...
                 <tr>
                     ...
                     <td>
                     <form action="php/deletev2.php" method="post" name="form">
