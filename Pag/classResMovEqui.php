...
class classResMovEqui extends FPDF
{
        ...
        function tabla1($cabecera, $val)
    {
       ...
       // foreach($cabecera as $fila)
        ...
        $this->Cell(74,4, $cabecera[1],1, 0 , 'C' );
    ...
    function fsolcomt($cabecera,$val)
    {
        ...
        $this->Cell(30,4, utf8_decode($cabecera[4]),1, 0 , 'C' );
        $this->Cell(19,4, utf8_decode($cabecera[5]),1, 0 , 'C' );
        $this->Cell(25,4, utf8_decode($cabecera[6]),1, 1 , 'C' );
