...
-- Tiempo de generación: 09-01-2019 a las 18:44:57
...
CREATE TABLE IF NOT EXISTS `departamentos` (
  ...
  KEY `fk_Departamentos_Estaciones1_idx` (`Estaciones_idEstaciones`)
...
INSERT INTO `departamentos` (`idDepartamentos`, `Nombre`, `Estaciones_idEstaciones`) VALUES
(1, 'Informatica', 1);
...
CREATE TABLE IF NOT EXISTS `mobiliarioyequipo` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_mobiliarioyequipo_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  KEY `fk_Usuario_Departamentos1_idx` (`Departamentos_idDepartamentos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `usuario` (`idUsuario`, `Departamentos_idDepartamentos`, `Nombre`, `Puesto`, `Calle`, `No`, `Col`, `Localidad`, `Telefono`, `Ext`, `Fax`, `E-mail`) VALUES
(1, 1, 'Dante', 'Director Infromatica', 'S/C', 'S/N', 'S/C', 'Pachuca', 'S/T', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `usuariosistema` (
  ...
  KEY `fk_UsuariosSistema_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `usuariosistema` (`idUsuariosSistema`, `User`, `Password`, `Usuario_idUsuario`) VALUES
(1, 'dante', '1234', 1);
...
CREATE TABLE IF NOT EXISTS `vehiculos` (
  ...
  `Color` varchar(15) NOT NULL,
  PRIMARY KEY (`Serie`),
  KEY `fk_vehiculos_Usuario1_idx` (`Usuario_idUsuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `departamentos`
  ADD CONSTRAINT `fk_Departamentos_Estaciones1` FOREIGN KEY (`Estaciones_idEstaciones`) REFERENCES `estaciones` (`idEstaciones`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `mobiliarioyequipo`
--
ALTER TABLE `mobiliarioyequipo`
  ADD CONSTRAINT `fk_mobiliarioyequipo_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_Usuario_Departamentos1` FOREIGN KEY (`Departamentos_idDepartamentos`) REFERENCES `departamentos` (`idDepartamentos`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `usuariosistema`
--
ALTER TABLE `usuariosistema`
  ADD CONSTRAINT `fk_UsuariosSistema_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `vehiculos`
--
ALTER TABLE `vehiculos`
  ADD CONSTRAINT `fk_vehiculos_Usuario1` FOREIGN KEY (`Usuario_idUsuario`) REFERENCES `usuario` (`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
